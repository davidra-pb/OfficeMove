export const PHASES = [
  { id: 1, name: 'גל 1 — חופשי', day: 1, time: '08:00-09:30', type: 'wave', color: '#22c55e', colorLight: '#dcfce7', count: 12 },
...
export const EMPLOYEES = [
  ...
  { id: 35, first: 'נתן', last: 'חדד', dept: 'משפטי', oldRoom: '10E', oldBld: 'אקרו', oldFloor: 7, newRoom: '13B', newBld: 'ישראל קנדה', newFloor: 6, phase: 1, replaces: 'חדר ריק' },
  ...
  { id: 53, first: 'טל', last: 'חוגי', dept: 'כספים', oldRoom: '12B', oldBld: 'ישראל קנדה', oldFloor: 6, newRoom: '7D', newBld: 'אקרו', newFloor: 8, phase: 4, replaces: 'אריאל סבג, יעל כספי (הנדסה)' },
